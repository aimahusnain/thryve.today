    ...
    >
      ...
      <div className={`relative space-y-6 h-full z-10 ${variant === "row" ? "md:col-span-4" : ""}`}>
        ...
        {variant === "row" && additionalInfo && (
          <p className="text-sm text-[#35dba8] dark:text-[#2db188] italic">{additionalInfo}</p>
        )}
      </div>
        ...
        <>
          ...
          {whoFor.length > 0 && (
            <div className="space-y-3 md:space-y-4 mt-4">
              <h4 className="text-sm md:text-base font-semibold text-zinc-900 dark:text-white flex items-center gap-2">
                <Users className="w-4 h-4 md:w-5 md:h-5 text-[#35dba8] dark:text-[#2db188]" /> Who Should Enroll?
              </h4>
              <ul
          ...
          {additionalInfo && <p className="text-sm text-[#35dba8] dark:text-[#2db188] italic mt-5">{additionalInfo}</p>}

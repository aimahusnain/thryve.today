...
export default async function CheckoutSuccessPage({
  ...
  // Await the searchParams promise to get the session_id
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="mb-8 relative">
              <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full opacity-10 dark:opacity-20 animate-ping" style={{ animationDuration: '3s' }}></div>
            ...
            <div className="space-y-4">
              ...
              <Link href="/courses" className="block">
                <Button variant="outline" className="w-full border-2 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 bg-transparent hover:bg-gray-50 dark:hover:bg-gray-800 font-medium py-2.5 rounded-xl transition-all duration-200">
                  Browse More Courses
                </Button>
              </Link>
            </div>

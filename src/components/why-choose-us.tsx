  ...
  return (
    <section className="relative py-20" id="why-us">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-0 w-96 h-96 bg-lime-200 dark:bg-lime-950 rounded-full filter blur-3xl -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-lime-200 dark:bg-lime-950 rounded-full filter blur-3xl translate-x-1/2 translate-y-1/2" />
      </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className={`group relative bg-white dark:bg-zinc-900 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden ${
                  index === 2 ? "md:col-span-2" : ""
                }`}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-lime-50 dark:from-lime-950 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          ...
          <motion.div variants={itemVariants} className="lg:col-span-1">
            <div className="bg-zinc-900 dark:bg-black text-white rounded-2xl p-8 h-full group">
              <div className="relative h-full flex flex-col">
                ...
                <p className="text-zinc-300 dark:text-zinc-400 leading-relaxed mb-8">

...
import { Calendar, CheckCircle, Clock, DollarSign, GraduationCap } from "lucide-react";
...
import { CourseDescriptionExpandable } from "@/components/courses/course-description-expandable";
        ...
        {courses.map((course) => (
          ...
          >
            ...
            <div className="relative space-y-6 h-full z-10">
              ...
              <CourseDescriptionExpandable description={course.description} />
              ...
              <div className="space-y-3 mt-0">
                ...
                <ul className="grid gap-2 md:gap-3">
                  ...
                  course.ProgramHighlights.length > 0 ? (
                    course.ProgramHighlights.slice(0, 4).map(
                      (highlight, index) => (
                        <li
                          key={index}
